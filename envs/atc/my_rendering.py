...
Edited by @PjrCodes to work with latest Pyglet and without OpenGL
"""
import os
import sys
...
class Line(Geom):
    ...
    def _render(self):
        l = pyglet.shapes.Line(self.start[0], self.start[1], self.end[0], self.end[1], color=self._color.vec4, width=self.linewidth)
        l.draw()
